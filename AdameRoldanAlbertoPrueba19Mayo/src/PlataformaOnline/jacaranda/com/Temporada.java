...
public class Temporada implements Comparable<Temporada> {
	...
	// Se ha utilizado un LinkedList porque queremos introducir un elemento en una
	// posición en concreta,
	// tomando como referecian el que tiene al lado
	...
	public String primerCapituloQueContieneEstaPalabara(String palabra) throws SerieException {///////////////////////////////////
		...
		if (!encontrado)
			throw new SerieException("Ningun capito contiene esta palabra");
		return resultado;
...
//	}
	...
	public String imprimirCapitulos(String nombre) {
		...
		for(String c : capitulos) {
			resultado.append(nombre +", " + this.nombreTemporada + ", " + c + "\n");//la forma correcta para que saliera como ped�a era introduciendo por par�metros el nombre 
		}
