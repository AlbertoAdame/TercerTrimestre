...
//		this.dado = dado;
	...
	private Coordenada getNextPosition(char direction) throws JuegoException {
		...
		if (direction == 'N') {
			...
			throw new JuegoException("Direcci�n no v�lida.");
	...
	public void proximoJugador() {
		if (coordenadaJugadores.size() - 1 == jugadorJuega) { // me dio problemas, ya que no tenemos que comparar el
																// size sin m�s, tendremos que compararlo el tama�o
																// menos 1
	...
	public String getNombreJuegadorQueJuega() {// Tener en cuenta que el nombre en el documento tiene una errata, y
												// podr�a darnos problemas en el futuro
